...
class RealL3T3IntegrationTests(unittest.TestCase):
    def test_nine_operating_points_and_reconstruction(self) -> None:
        ffmpeg = find_ffmpeg()
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            expected = {
                "op_s0_t0.obu": (96, 54, 6),
                "op_s0_t1.obu": (96, 54, 12),
                "op_s0_t2.obu": (96, 54, 24),
                "op_s1_t0.obu": (192, 108, 6),
                "op_s1_t1.obu": (192, 108, 12),
                "op_s1_t2.obu": (192, 108, 24),
                "op_s2_t0.obu": (384, 216, 6),
                "op_s2_t1.obu": (384, 216, 12),
                "op_s2_t2.obu": (384, 216, 24),
            }
